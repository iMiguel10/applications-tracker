...
>     - F11 (en construcción; falta el rate limiting):
...
>     - **El resto de la v2**: de F11, el rate limiting; y F12–F17 (notificaciones por email, perfil y CVs, IA, Kanban y calendario). Solo existe su diseño (§2). Ninguno de sus servicios, comandos ni carpetas está en el repositorio: no los ejecutes ni los busques hasta que se construya su fase.
...
| F11 | **v2.** Recuperación de contraseña, verificación de email, zona horaria, límites visibles y rate limiting. **En construcción** (hechos: base con `GET /meta`, recuperación/cambio de contraseña, verificación de email, zona horaria y límites visibles; falta el rate limiting) |
