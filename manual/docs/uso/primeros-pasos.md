...
1. En la pantalla de inicio de sesión, pulsa **Crear cuenta**.
2. Escribe tu email y una contraseña, y repítela.
3. Pulsa **Crear cuenta**. Entrarás directamente en la aplicación.
