...
| A39 | Zona horaria | `users.timezone` con un nombre IANA (`Europe/Madrid`), validado contra `zoneinfo`; el frontend la envía si está vacía | **Un desfase numérico (`+02:00`)**: se rompe dos veces al año con el horario de verano. |
...
| WeasyPrint y sus librerías de sistema en la imagen (R9) | F9 existe para descubrirlo antes de construir encima |
